const headlines = [
  {
    type: "animated",
    text: "Developers, Programmers, Graphic Designers",
  },
  {
    type: "static",
    text: "are",
  ...
  {
    type: "animated",
    text: "Genius, Smart, Creative",
  },
];

const headlineContainer = document.querySelector(".headline");
const animation = "fade"; //{typing, scale, fallingLetters, slidingLetters, scalingLetters, jelly, fade}
